...
public class EducationController {
    ...
    public EducationResponse getEducationListbyId(@PathVariable String resumeId) {
        return service.getEducationbyResourceId(getUuid(resumeId));
    }
    ...
    public EducationResponse createEducationList(@RequestBody EducationRequest request) {
        return service.saveEducation(request);
    }
    ...
    public GenericDeleteResponse deleteEducationList(@PathVariable String resumeId,
                                                     @RequestParam(required = false) String id) {
        return (id != null) ? service.deleteEducationbyId(getUuid(resumeId), getUuid(id))
                : service.deleteEducationbyResumeId(getUuid(resumeId));
    }
}